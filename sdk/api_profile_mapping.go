...
func (a *ProfileMappingAPIService) GetProfileMappingExecute(r ApiGetProfileMappingRequest) (*APIResponse, error) {
	var (
...
func (a *ProfileMappingAPIService) ListProfileMappingsExecute(r ApiListProfileMappingsRequest) (*APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (a *ProfileMappingAPIService) UpdateProfileMappingExecute(r ApiUpdateProfileMappingRequest) (*APIResponse, error) {
	var (
