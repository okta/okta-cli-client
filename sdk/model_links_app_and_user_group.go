...
// LinksAppAndUserGroup struct for LinksAppAndUserGroup
type LinksAppAndUserGroup struct {
...
type _LinksAppAndUserGroup LinksAppAndUserGroup
...
func (o LinksAppAndUserGroup) MarshalJSON() ([]byte, error) {
...
func (o *LinksAppAndUserGroup) UnmarshalJSON(bytes []byte) (err error) {
	varLinksAppAndUserGroup := _LinksAppAndUserGroup{}

	err = json.Unmarshal(bytes, &varLinksAppAndUserGroup)
	if err == nil {
		*o = LinksAppAndUserGroup(varLinksAppAndUserGroup)
	} else {
		return err
	}
...
type NullableLinksAppAndUserGroup struct {
	value *LinksAppAndUserGroup
	isSet bool
}

func (v NullableLinksAppAndUserGroup) Get() *LinksAppAndUserGroup {
	return v.value
}

func (v *NullableLinksAppAndUserGroup) Set(val *LinksAppAndUserGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableLinksAppAndUserGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableLinksAppAndUserGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinksAppAndUserGroup(val *LinksAppAndUserGroup) *NullableLinksAppAndUserGroup {
	return &NullableLinksAppAndUserGroup{value: val, isSet: true}
}

func (v NullableLinksAppAndUserGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinksAppAndUserGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
