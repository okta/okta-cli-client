...
type APIClient struct {
	...
	HookPasswordAPI HookPasswordAPI
	...
	ResourceSelectorsAPI ResourceSelectorsAPI
...
func (a *JWKAuth) Authorize() error {
	accessToken, hasToken := a.tokenCache.Get(AccessTokenCacheKey)
	if hasToken {
		a.req.Header.Add("Authorization", "Bearer "+accessToken.(string))
	} else {
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.HookPasswordAPI = (*HookPasswordAPIService)(&c.common)
	...
	c.PrivilegedResourceAPI = (*PrivilegedResourceAPIService)(&c.common)
	...
	c.ResourceSelectorsAPI = (*ResourceSelectorsAPIService)(&c.common)
	...
	c.YourOinIntegrationsAPI = (*YourOinIntegrationsAPIService)(&c.common)
