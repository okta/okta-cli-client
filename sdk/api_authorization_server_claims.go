...
func (a *AuthorizationServerClaimsAPIService) CreateOAuth2ClaimExecute(r ApiCreateOAuth2ClaimRequest) (*APIResponse, error) {
	var (
...
func (a *AuthorizationServerClaimsAPIService) GetOAuth2ClaimExecute(r ApiGetOAuth2ClaimRequest) (*APIResponse, error) {
	var (
...
func (a *AuthorizationServerClaimsAPIService) ListOAuth2ClaimsExecute(r ApiListOAuth2ClaimsRequest) (*APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (a *AuthorizationServerClaimsAPIService) ReplaceOAuth2ClaimExecute(r ApiReplaceOAuth2ClaimRequest) (*APIResponse, error) {
	var (
