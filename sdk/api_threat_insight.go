...
func (a *ThreatInsightAPIService) GetCurrentConfigurationExecute(r ApiGetCurrentConfigurationRequest) (*APIResponse, error) {
	var (
...
func (a *ThreatInsightAPIService) UpdateConfigurationExecute(r ApiUpdateConfigurationRequest) (*APIResponse, error) {
	var (
