...
func (a *DeviceAPIService) GetDeviceExecute(r ApiGetDeviceRequest) (*APIResponse, error) {
	var (
...
func (a *DeviceAPIService) ListDeviceUsersExecute(r ApiListDeviceUsersRequest) (*APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (a *DeviceAPIService) ListDevicesExecute(r ApiListDevicesRequest) (*APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
