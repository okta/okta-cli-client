...
func (a *AuthorizationServerKeysAPIService) ListAuthorizationServerKeysExecute(r ApiListAuthorizationServerKeysRequest) (*APIResponse, error) {
	var (
...
func (a *AuthorizationServerKeysAPIService) RotateAuthorizationServerKeysExecute(r ApiRotateAuthorizationServerKeysRequest) (*APIResponse, error) {
	var (
