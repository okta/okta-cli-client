...
func (a *GroupOwnerAPIService) AssignGroupOwnerExecute(r ApiAssignGroupOwnerRequest) (*APIResponse, error) {
	var (
...
func (a *GroupOwnerAPIService) ListGroupOwnersExecute(r ApiListGroupOwnersRequest) (*APIResponse, error) {
	var (
