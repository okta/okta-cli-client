...
*AuthenticatorAPI* | [**MapAuthenticatorPolicyMapping**](docs/AuthenticatorAPI.md#mapauthenticatorpolicymapping) | **Post** /api/v1/authenticators/{authenticatorId}/policies | Map an Authenticator to a Policy
...
*YourOinIntegrationsAPI* | [**CreateSubmission**](docs/YourOinIntegrationsAPI.md#createsubmission) | **Post** /integrations/api/v1/submissions | Create an OIN Integration
*YourOinIntegrationsAPI* | [**GetSubmissionByOperationId**](docs/YourOinIntegrationsAPI.md#getsubmissionbyoperationid) | **Get** /integrations/api/v1/submissions/{submissionId} | Retrieve an OIN Integration
*YourOinIntegrationsAPI* | [**GetSubmissionTestInfo**](docs/YourOinIntegrationsAPI.md#getsubmissiontestinfo) | **Get** /integrations/api/v1/submissions/{submissionId}/testing | Retrieve an OIN Integration Testing Information
*YourOinIntegrationsAPI* | [**ListSubmissions**](docs/YourOinIntegrationsAPI.md#listsubmissions) | **Get** /integrations/api/v1/submissions | List all OIN Integrations
*YourOinIntegrationsAPI* | [**ReplaceSubmission**](docs/YourOinIntegrationsAPI.md#replacesubmission) | **Put** /integrations/api/v1/submissions/{submissionId} | Replace an OIN Integration
*YourOinIntegrationsAPI* | [**SubmitSubmission**](docs/YourOinIntegrationsAPI.md#submitsubmission) | **Post** /integrations/api/v1/submissions/{submissionId}/submit | Submit an OIN Integration
*YourOinIntegrationsAPI* | [**UploadSubmissionLogo**](docs/YourOinIntegrationsAPI.md#uploadsubmissionlogo) | **Post** /integrations/api/v1/submissions/logo | Upload an OIN Integration logo
*YourOinIntegrationsAPI* | [**UpsertSubmissionTestInfo**](docs/YourOinIntegrationsAPI.md#upsertsubmissiontestinfo) | **Put** /integrations/api/v1/submissions/{submissionId}/testing | Upsert an OIN Integration Testing Information
...
## Documentation For Models
 ...
 - [CreatePasswordImportInlineHookRequest](docs/CreatePasswordImportInlineHookRequest.md)
 - [CreatePolicyRequest](docs/CreatePolicyRequest.md)
 - [CreatePrivilegedResourceRequest](docs/CreatePrivilegedResourceRequest.md)
 ...
 - [LinksAppAndUserGroup](docs/LinksAppAndUserGroup.md)
 ...
 - [MapAuthenticatorPolicyMappingRequest](docs/MapAuthenticatorPolicyMappingRequest.md)
 ...
 - [PolicyCanBeCreatedOrReplaced](docs/PolicyCanBeCreatedOrReplaced.md)
 ...
 - [PrivilegedResourceAccountOktaAllOfCredentials](docs/PrivilegedResourceAccountOktaAllOfCredentials.md)
 - [PrivilegedResourceCredentials](docs/PrivilegedResourceCredentials.md)
 - [PrivilegedResourceCredentialsPassword](docs/PrivilegedResourceCredentialsPassword.md)
